...
void formTestTextNotoSerifHintsAuto_reset(AppState* state)
{
	//FormData* data = (FormData*)state->form_data;
}

void formTestTextNotoSerifHintsAuto_onDraw(AppState* state)
{
...
#define setTextColor	setTextRGBColor
	...
	setGFXFont(&NotoSerif_Regular6pt7b_hintingauto);
	setTextColor(text_color_1);
	drawString(10, y, "NotoSerif 6, 9, auto");
	y += NotoSerif_Regular6pt7b_hintingauto.yAdvance - 2;
	...
	setGFXFont(&NotoSerif_Bold6pt7b_hintingauto);
	setTextColor(text_color_5);
	drawString(2, y, "Bold Text");
	y += NotoSerif_Bold6pt7b_hintingauto.yAdvance - 2;

	setGFXFont(&NotoSerif_Italic6pt7b_hintingauto);
	setTextColor(text_color_6);
	drawString(2, y, "Italic Text");
	y += NotoSerif_Italic6pt7b_hintingauto.yAdvance - 2;

	setGFXFont(&NotoSerif_BoldItalic6pt7b_hintingauto);
	setTextColor(text_color_7);
	drawString(2, y, "Bold Italic Text");
	y += NotoSerif_BoldItalic6pt7b_hintingauto.yAdvance - 2;

	// 9pt
	setGFXFont(&NotoSerif_Regular9pt7b_hintingauto);
	setTextColor(text_color_1);
	drawString(2, y, "0123ABCabc");
	y += NotoSerif_Regular9pt7b_hintingauto.yAdvance - 4;

	setGFXFont(&NotoSerif_Bold9pt7b_hintingauto);
	setTextColor(text_color_2);
	drawString(2, y, "0123ABCabc");
	y += NotoSerif_Bold9pt7b_hintingauto.yAdvance - 4;

	setGFXFont(&NotoSerif_Italic9pt7b_hintingauto);
	setTextColor(text_color_3);
	drawString(2, y, "0123ABCabc");
	y += NotoSerif_Italic9pt7b_hintingauto.yAdvance - 4;

	setGFXFont(&NotoSerif_BoldItalic9pt7b_hintingauto);
	setTextColor(text_color_4);
	drawString(2, y, "0123ABCabc");
	//y += NotoSerif_BoldItalic9pt7b_hintingauto.yAdvance - 4;
}

void formTestTextNotoSerifHintsAuto_onButton(AppState* state, uint8_t btn)
{
	//FormData* data = (FormData*)state->form_data;
	switch (btn)
	{
